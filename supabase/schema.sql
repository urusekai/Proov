...
insert into public.problem_sets (
  ...
  ('7d49a081-9dc6-4631-b952-9c35ac21be86', null, 'CURATED', 'PUBLIC', 'IPv6 문자열 변환 규칙 읽기', 'BEGINNER', 8, ARRAY['TypeScript']::text[], ARRAY[]::text[], ARRAY[]::text[], ARRAY['IPv6', 'String Formatting', 'Utility Function']::text[], 'https://github.com/honojs/hono/pull/4971', 'fix(utils/ipaddr): do not compress a single 0 group to `::`', 'honojs', 'hono', 4971, '{"curatedSlug":"hono-ipv6-string-formatting","sourceFiles":["src/utils/ipaddr.test.ts","src/utils/ipaddr.ts"]}'::jsonb, '2026-04-22T00:00:00.000Z'::timestamptz),
  ('719c621c-98c7-40a1-9376-c3c76d551bc4', null, 'CURATED', 'PUBLIC', '정적 파일 경로 정규화 흐름 이해하기', 'BEGINNER', 8, ARRAY['TypeScript']::text[], ARRAY['Hono']::text[], ARRAY[]::text[], ARRAY['Static Files', 'Path Normalization', 'File Serving']::text[], 'https://github.com/honojs/hono/pull/4962', 'fix(serve-static): normalize all backslashes in file paths, not just the first', 'honojs', 'hono', 4962, '{"curatedSlug":"hono-static-path-normalization","sourceFiles":["src/utils/filepath.test.ts","src/utils/filepath.ts"]}'::jsonb, '2026-04-21T00:00:00.000Z'::timestamptz),
  ('760913a7-05b4-452f-972d-ac8975ac6a1f', null, 'CURATED', 'PUBLIC', 'TypeScript 미들웨어 선언 구조 정리', 'BEGINNER', 8, ARRAY['TypeScript']::text[], ARRAY[]::text[], ARRAY['Zustand']::text[], ARRAY['Type Declarations', 'Middleware', 'DevTools']::text[], 'https://github.com/pmndrs/zustand/pull/3443', 'refactor(devtools): remove duplicate module augmentation', 'pmndrs', 'zustand', 3443, '{"curatedSlug":"zustand-devtools-type-declaration","sourceFiles":["src/middleware/devtools.ts"]}'::jsonb, '2026-04-20T00:00:00.000Z'::timestamptz),
  ('c334801f-ca77-4426-9625-03ee0d213625', null, 'CURATED', 'PUBLIC', '요청 초기화 훅의 옵션 복제 흐름', 'INTERMEDIATE', 8, ARRAY['TypeScript']::text[], ARRAY[]::text[], ARRAY['Ky']::text[], ARRAY['HTTP Client', 'Hooks', 'Request Options']::text[], 'https://github.com/sindresorhus/ky/pull/861', 'fix: isolate tuple searchParams in init hooks', 'sindresorhus', 'ky', 861, '{"curatedSlug":"ky-init-hook-search-params","sourceFiles":["source/core/Ky.ts","test/hooks.ts"]}'::jsonb, '2026-04-19T00:00:00.000Z'::timestamptz),
  ('a621a7e0-8511-4760-be3e-fda5155336df', null, 'CURATED', 'PUBLIC', 'JSON 파싱 콜백의 컨텍스트 전달', 'ADVANCED', 8, ARRAY['TypeScript']::text[], ARRAY[]::text[], ARRAY['Ky']::text[], ARRAY['HTTP Client', 'JSON Parsing', 'Error Handling']::text[], 'https://github.com/sindresorhus/ky/pull/849', 'Add request/response context to `parseJson` option', 'sindresorhus', 'ky', 849, '{"curatedSlug":"ky-json-parser-context","sourceFiles":["source/core/Ky.ts","source/types/options.ts","test/http-error.ts","test/main.ts"]}'::jsonb, '2026-04-18T00:00:00.000Z'::timestamptz),
  ('824a3fd3-0238-47a8-ad0a-22e60b5fa6d2', null, 'CURATED', 'PUBLIC', '폼 상태 알림의 범위 구분', 'INTERMEDIATE', 8, ARRAY['TypeScript', 'React']::text[], ARRAY['React']::text[], ARRAY['React Hook Form']::text[], ARRAY['Form State', 'Subscriptions', 'Batch Updates']::text[], 'https://github.com/react-hook-form/react-hook-form/pull/13450', 'fix(setValues): emit whole-form change without stale name/type', 'react-hook-form', 'react-hook-form', 13450, '{"curatedSlug":"react-hook-form-bulk-value-notification","sourceFiles":["src/__tests__/useForm/setValues.test.tsx","src/logic/createFormControl.ts"]}'::jsonb, '2026-04-17T00:00:00.000Z'::timestamptz),
  ('a34b165c-1095-4f9a-b040-02ffd93460a7', null, 'CURATED', 'PUBLIC', 'IPv6 CIDR 검증과 JSON Schema 패턴', 'INTERMEDIATE', 8, ARRAY['TypeScript']::text[], ARRAY[]::text[], ARRAY['Zod']::text[], ARRAY['Validation', 'JSON Schema', 'CIDR']::text[], 'https://github.com/colinhacks/zod/pull/5945', 'fix(v4): cidrv6 JSON schema pattern matches runtime', 'colinhacks', 'zod', 5945, '{"curatedSlug":"zod-cidrv6-schema-pattern","sourceFiles":["packages/zod/src/v4/classic/tests/string.test.ts","packages/zod/src/v4/core/regexes.ts"]}'::jsonb, '2026-04-16T00:00:00.000Z'::timestamptz),
  ('de1266f5-0a71-4957-b0a2-4edba7aba796', null, 'CURATED', 'PUBLIC', '객체 파싱에서 fallback 값 처리', 'ADVANCED', 8, ARRAY['TypeScript']::text[], ARRAY[]::text[], ARRAY['Zod']::text[], ARRAY['Validation', 'Object Parsing', 'Fallback Values']::text[], 'https://github.com/colinhacks/zod/pull/5939', 'fix(v4): restore catch handling for absent object keys', 'colinhacks', 'zod', 5939, '{"curatedSlug":"zod-object-fallback-semantics","sourceFiles":["packages/zod/src/v4/classic/tests/catch.test.ts","packages/zod/src/v4/classic/tests/partial.test.ts","packages/zod/src/v4/core/schemas.ts"]}'::jsonb, '2026-04-15T00:00:00.000Z'::timestamptz),
  ('437cefe8-b5f5-4bb0-b3d2-854d066f3284', null, 'CURATED', 'PUBLIC', '응답 trailer 완료 처리 흐름', 'INTERMEDIATE', 8, ARRAY['JavaScript']::text[], ARRAY['Fastify']::text[], ARRAY[]::text[], ARRAY['HTTP Response', 'Trailers', 'Async Completion']::text[], 'https://github.com/fastify/fastify/pull/6714', 'fix: ignore duplicate trailer completions', 'fastify', 'fastify', 6714, '{"curatedSlug":"fastify-reply-trailer-completion","sourceFiles":["lib/reply.js","test/reply-trailers.test.js"]}'::jsonb, '2026-04-14T00:00:00.000Z'::timestamptz),
  ('09484372-e725-4584-8710-9d03599d1786', null, 'CURATED', 'PUBLIC', 'Content-Type 파싱 객체 재사용', 'INTERMEDIATE', 8, ARRAY['JavaScript']::text[], ARRAY['Fastify']::text[], ARRAY[]::text[], ARRAY['Content-Type', 'Caching', 'Request Handling']::text[], 'https://github.com/fastify/fastify/pull/6694', 'perf: cache parsed ContentType objects in ContentTypeParser', 'fastify', 'fastify', 6694, '{"curatedSlug":"fastify-content-type-parser-cache","sourceFiles":["lib/content-type-parser.js","lib/handle-request.js","lib/request.js"]}'::jsonb, '2026-04-13T00:00:00.000Z'::timestamptz),
  ('30918f4b-fd97-4342-8aef-eafc790fb6f2', null, 'CURATED', 'PUBLIC', '로그아웃 이후 사용자 상태 초기화 흐름 읽기', 'INTERMEDIATE', 8, ARRAY['JavaScript', 'Vue']::text[], ARRAY['Vue', 'Pinia']::text[], ARRAY['vue-router']::text[], ARRAY['State Management', 'Authentication', 'Routing', 'Logout Flow']::text[], 'https://github.com/urusekai/TONE/pull/145', 'Feat: 기능 추가', 'urusekai', 'TONE', 145, '{"curatedSlug":"tone-logout-user-state-reset","sourceFiles":["frontend/src/router/index.js","frontend/src/stores/dailySpectrum.js","frontend/src/stores/player.js","frontend/src/stores/resetAllUserState.js","frontend/src/stores/toast.js","frontend/src/views/MyPageView.vue","frontend/src/views/PaletteLogView.vue"]}'::jsonb, '2026-05-01T00:00:00.000Z'::timestamptz),
  ('cc402d3d-a884-4262-a292-ad5429228eb1', null, 'CURATED', 'PUBLIC', '한 곡 반복 재생 상태 흐름 이해하기', 'INTERMEDIATE', 8, ARRAY['JavaScript', 'Vue']::text[], ARRAY['Vue', 'Pinia']::text[], ARRAY[]::text[], ARRAY['Audio Player', 'Playback State', 'Repeat Mode']::text[], 'https://github.com/urusekai/TONE/pull/110', 'fix: 한곡 반복 버그 수정', 'urusekai', 'TONE', 110, '{"curatedSlug":"tone-repeat-one-playback-reset","sourceFiles":["frontend/src/layouts/AppLayout.vue","frontend/src/stores/player.js","frontend/src/views/PlaylistView.vue"]}'::jsonb, '2026-04-30T00:00:00.000Z'::timestamptz),
  ('639a47e0-72d1-4fa8-bf95-65f3f66e1d44', null, 'CURATED', 'PUBLIC', '프로필 색상 상태 공유 흐름 읽기', 'INTERMEDIATE', 8, ARRAY['JavaScript', 'Vue']::text[], ARRAY['Vue', 'Pinia']::text[], ARRAY[]::text[], ARRAY['State Management', 'Local Storage', 'Profile Color']::text[], 'https://github.com/urusekai/TONE/pull/74', 'feat:캘린더 프로필 설정 버튼 누르면 상단 우측 아바타 색상 변경 기능 추가 및 Pinia 스토어 생성', 'urusekai', 'TONE', 74, '{"curatedSlug":"tone-profile-avatar-color-store","sourceFiles":["frontend/src/components/Header.vue","frontend/src/components/MainPlayer.vue","frontend/src/stores/uiStore.js","frontend/src/views/CalendarView.vue"]}'::jsonb, '2026-04-29T00:00:00.000Z'::timestamptz),
  ('0cb24805-7c8f-499f-b0b0-01cb9806cc73', null, 'CURATED', 'PUBLIC', '회원 탈퇴 요청과 세션 정리 흐름 이해하기', 'INTERMEDIATE', 8, ARRAY['PHP', 'JavaScript', 'Vue']::text[], ARRAY['Vue']::text[], ARRAY[]::text[], ARRAY['Account Deletion', 'Authentication', 'Session']::text[], 'https://github.com/urusekai/TONE/pull/73', 'feat: 회원 탈퇴 구현', 'urusekai', 'TONE', 73, '{"curatedSlug":"tone-account-withdraw-session-cleanup","sourceFiles":["backend/api/auth/withdraw.php","frontend/src/services/userService.js","frontend/src/views/MyPageView.vue"]}'::jsonb, '2026-04-28T00:00:00.000Z'::timestamptz),
  ('884bd125-4f31-406b-8935-6528ddeded90', null, 'CURATED', 'PUBLIC', '로그아웃 요청과 클라이언트 상태 정리 흐름', 'BEGINNER', 8, ARRAY['PHP', 'JavaScript', 'Vue']::text[], ARRAY['Vue']::text[], ARRAY[]::text[], ARRAY['Logout Flow', 'Authentication', 'Session']::text[], 'https://github.com/urusekai/TONE/pull/65', 'feat: 마이페이지에서 로그아웃 구현', 'urusekai', 'TONE', 65, '{"curatedSlug":"tone-my-page-logout-flow","sourceFiles":["backend/api/auth/logout.php","frontend/src/services/authService.js","frontend/src/views/MyPageView.vue"]}'::jsonb, '2026-04-27T00:00:00.000Z'::timestamptz),
  ('3791a4e7-deb7-4d39-8dfd-ca78fde76aa0', null, 'CURATED', 'PUBLIC', '카테고리 카드 응답 매핑 단순화 읽기', 'BEGINNER', 8, ARRAY['JavaScript', 'Vue']::text[], ARRAY['Vue']::text[], ARRAY[]::text[], ARRAY['API Response', 'Data Mapping', 'Playlist Card']::text[], 'https://github.com/urusekai/TONE/pull/100', 'refactor: API 응답을 프론트에서 정규화하는 과정을 축소', 'urusekai', 'TONE', 100, '{"curatedSlug":"tone-category-card-response-mapping","sourceFiles":["frontend/src/views/CategoryDetailView.vue"]}'::jsonb, '2026-04-26T00:00:00.000Z'::timestamptz),
  ('39312fae-6062-4bca-b251-8bd2a57ee867', null, 'CURATED', 'PUBLIC', '소셜 로그인 계정 연결 흐름 이해하기', 'ADVANCED', 8, ARRAY['JavaScript']::text[], ARRAY['Express']::text[], ARRAY['Mongoose']::text[], ARRAY['Social Login', 'Authentication', 'Account Linking', 'OAuth']::text[], 'https://github.com/muteLJS/GOREON/pull/187', 'Fix Kakao social login duplicate email handling', 'muteLJS', 'GOREON', 187, '{"curatedSlug":"goreon-social-login-account-linking","sourceFiles":["backend/src/controllers/authController.js","backend/src/models/User.js","backend/src/services/authService.js"]}'::jsonb, '2026-04-25T00:00:00.000Z'::timestamptz),
  ('38d0b8d7-a493-4e97-84e0-48a9dffc365c', null, 'CURATED', 'PUBLIC', '카카오 이메일 동의 검증 흐름 읽기', 'BEGINNER', 8, ARRAY['JavaScript', 'React']::text[], ARRAY['React']::text[], ARRAY[]::text[], ARRAY['Social Login', 'OAuth', 'Validation', 'Error Message']::text[], 'https://github.com/muteLJS/GOREON/pull/149', '소셜 로그인 카카오 이메일 동의항목 추가 완료', 'muteLJS', 'GOREON', 149, '{"curatedSlug":"goreon-kakao-email-consent","sourceFiles":["backend/src/services/socialOAuthService.js","frontend/src/pages/Login/Login.jsx"]}'::jsonb, '2026-04-24T00:00:00.000Z'::timestamptz),
  ('eecef31b-eedc-4824-a59d-5c592a70f42b', null, 'CURATED', 'PUBLIC', '주문 상품별 구매 확정 상태 흐름 읽기', 'INTERMEDIATE', 8, ARRAY['JavaScript', 'React']::text[], ARRAY['Express', 'React']::text[], ARRAY['Mongoose']::text[], ARRAY['Order Status', 'Purchase Confirmation', 'API Contract']::text[], 'https://github.com/muteLJS/GOREON/pull/154', '구매확정 버튼 수정', 'muteLJS', 'GOREON', 154, '{"curatedSlug":"goreon-order-item-confirmation","sourceFiles":["backend/src/controllers/orderController.js","backend/src/models/Order.js","backend/src/routes/orderRoutes.js","frontend/src/pages/OrderHistory/OrderHistory.jsx"]}'::jsonb, '2026-04-23T00:00:00.000Z'::timestamptz)
on conflict (id) do update set
